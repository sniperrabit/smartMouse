...
public class BluetoothChatService { 
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(MainView.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
...
//        mHandler.sendMessage(msg);
    ...
    public synchronized void stop() {
    	  System.out.println("STOP : all cancel");
        if (mConnectThread != null) {mConnectThread.cancel(); mConnectThread = null;}
        System.out.println("STOP : mConnectThread");
        if (mConnectedThread != null) {mConnectedThread.cancel(); mConnectedThread = null;}
        System.out.println("STOP : mConnectedThread");
        if (mAcceptThread != null) {mAcceptThread.cancel(); mAcceptThread = null;}
        System.out.println("STOP : mAcceptThread");
        setState(STATE_NONE);
    }
    ...
    private void connectionFailed() {
        setState(STATE_LISTEN);
        System.out.println("connectionFailed : STATE_LISTEN");
    ...
    private void connectionLost() {
        setState(STATE_LISTEN);
        System.out.println("connectionLOST : STATE_LISTEN");
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(MainView.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            setName("BEGIN mAcceptThread " +this);
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    System.out.println("BEGIN mAcceptThread SOCKET ACCEPTED");
                } catch (IOException e) {
        ...
        public void cancel() {
            ...
            try {
                mmServerSocket.close();
            	 ...
            	 System.out.println("close() of server failed "+e);
       ...
       //     	System.out.println("Reset the ConnectThread because we're done");
        ...
        public void cancel() {
            try {
            	...
            	System.out.println("close() of connect socket failed "+ e);
